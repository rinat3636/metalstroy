...
export const BOT_ADMIN_CONNECTED_TEXT = [
  ...
  "",
  "Других ролей у бота нет — только уведомления для администраторов.",
].join("\n");

export const BOT_ALREADY_CONNECTED_TEXT = [
  "Вы уже подключены как админ.",
  "",
  "Заявки с сайта будут приходить в этот чат.",
].join("\n");

export const BOT_HELP_TEXT = [
  "Профсталь-инвест — бот для админов.",
  "",
  "/start — подключить уведомления о заявках с сайта",
].join("\n");
